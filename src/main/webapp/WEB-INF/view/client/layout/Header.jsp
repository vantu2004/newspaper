			...
			<div
				...
				<div class="navbar-nav">
					<a href="/" class="nav-item nav-link active">Trang Chủ</a> <a
						href="/products" class="nav-item nav-link">Sản Phẩm</a>
				...
				<div class="d-flex m-3 me-0">
					...
					<!-- pageContext dùng để truy cập vào request, userPrincipal lưu thông
					tin người dùng đã đăng nhập -->
						...
						<div class="dropdown my-auto">
							...
							<ul class="dropdown-menu dropdown-menu-end p-4"
								...
								<li class="d-flex align-items-center flex-column"
									...
									<!-- xuất username, name ở đây là username được lưu trong userPrincipal -->
